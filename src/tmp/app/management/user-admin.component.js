...
var UserAdminComponent = (function () {
    function UserAdminComponent(authService, router) {
        this.authService = authService;
        this.router = router;
        this.setMessage();
    }
    UserAdminComponent.prototype.setMessage = function () {
        this.message = 'Logged ' + (this.authService.isLoggedIn ? 'in' : 'out');
    };
    UserAdminComponent.prototype.login = function () {
        var _this = this;
    ...
    UserAdminComponent.prototype.logout = function () {
